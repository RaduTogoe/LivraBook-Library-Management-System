...
public class RegisterFrame extends JFrame{
	...
	public RegisterFrame() {
		...
		registerButton.setBounds(40, 700, 300, 100);
		...
		registerButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Biblioteca.utilizatorLogat = new Client(numeField.getText(), prenumeField.getText(), dataNasteriiField.getText(), emailField.getText(), numarTelefonField.getText(), adresaField.getText(), usernameField.getText(), password);
                Biblioteca.utilizatori.add(new Client(numeField.getText(), prenumeField.getText(), dataNasteriiField.getText(), emailField.getText(), numarTelefonField.getText(), adresaField.getText(), usernameField.getText(), password));
                Biblioteca.clienti.add(new Client(numeField.getText(), prenumeField.getText(), dataNasteriiField.getText(), emailField.getText(), numarTelefonField.getText(), adresaField.getText(), usernameField.getText(), password));
